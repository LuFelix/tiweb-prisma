...
public class AtualizaYahoo {
	...
	public void atualizaJSON() throws IOException {
	...
	public void atualizaCSV(String idYahoo) throws Exception {
		...
		System.out.println("valores para " + idYahoo);
