...
public class PainelStatus extends JPanel {
	...
	void iniciaComponentes() {
		...
		lblNomeTela = new JLabel("Resumos");
		lblNomeTela.setFont(new Font("Times New Roman", Font.BOLD, 28));

		lbl02 = new JLabel("Total de Receitas:");
		txtF02 = new JTextField();

		lbl03 = new JLabel("Realizado de Receitas:");
		...
		lbl05 = new JLabel("Total de Despesas: ");
		txtF05 = new JTextField();

		lbl06 = new JLabel("Realizado de Despesas:");
