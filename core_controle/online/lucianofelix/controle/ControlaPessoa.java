...
public class ControlaPessoa {
	 ...
	 * 
	 * @param nomePessoa
	 * @return codiPessoa - code of user
	 * @return null if the name in the parameter is null or
	 */
	public String pesqCodigoNome(String nomePessoa) {
		if (nomePessoa != null) {
			Pessoa pessoa = daoP.pessoaNome(nomePessoa);
	...
	/**
	 * Carregar um combobox com as opÁıes de grupo por tipo de sistema
	 * 
	 * @return ComboBox
	 */
	public JComboBox<String> carregarGrupos() {
		...
		listGrupo = daoG.listPorTipoSistema(1);
	...
	/**
	 * Implementar o controle de funcion·rios
	 * 
	 * @param p
	 * @return
	 */
	...
	/**
	 * Adicionar um n˙mero de telefone excutando as validacoes
	 */
	public void addFone() {

		JOptionPane.showInputDialog(
				"Digite o telefone com DDD\n*Apenas os numeros, sem espaÁos.\n;>)");
	}
	public void addEmail() {
		JOptionPane.showInputDialog(
				"Digite o e-mail.\n*Lembre da @ e dos 'pontos'.\n;>)");
	}
}
