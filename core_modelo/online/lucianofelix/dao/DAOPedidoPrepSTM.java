...
public class DAOPedidoPrepSTM {
	...
	public ArrayList<Pedido> pesquisarTipoASC(String tipoPedido) {
	...
	public ArrayList<Pedido> pesquisarTipoDSC(String tipoPedido) {
		String sql = "select * from pedidos where tipo_pedido = ? order by seq_pedido desc;";
		arraypedi = new ArrayList<Pedido>();
		c.conectar();
		try {
			prepStm = c.getCon().prepareStatement(sql,
